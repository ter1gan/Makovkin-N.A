...
name = str(input('Укажите свое имя: '))                                                   #4#
if name == ('Иван'):
    print('Ваше имя не подходит')
if age < 16:
    print('Вам осталось учиться в школе ',16-age,'лет')
sekonds = int(input("Введите кол-во секунд "))                                            #5#
min = sekonds//60
hours = min//60
days = hours//24
print(days, ":" , hours, ":", min, ":", sekonds )
n = int(input('''Укажите число для решения выражения n + n^2 + n^3 + n^4 + n^5: '''))     #6#
...
print(a)
print(b)
number = int(input('Введите число, '))                                                   #7#
if number % 2 == 0:
    print('Четное число')
else:
